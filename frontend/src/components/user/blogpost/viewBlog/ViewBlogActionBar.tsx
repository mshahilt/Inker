...
const ViewBlogActionBar: FC<ViewBlogActionBarProps> = ({ blogId, comments, upVotes, downVotes, authorId }) => {
    ...
    return (
        <div className="flex flex-wrap sm:flex-nowrap justify-end items-center gap-2 sm:gap-3 border-b py-2 px-2 sm:px-4 overflow-x-auto sm:overflow-visible">
            ...
            >
                <Clipboard className="w-4 h-4 sm:w-[17px] sm:h-[17px] cursor-pointer" strokeWidth={1} />
            </div>
            ...
            <div className="flex items-center justify-center gap-1 p-1 text-xs sm:text-sm border px-2 rounded-md hover:bg-muted cursor-pointer">
                ...
                <MessageCircle className="w-4 h-4 sm:w-[17px] sm:h-[17px] cursor-pointer" strokeWidth={1} />
            </div>

            <div className="flex items-center gap-2 justify-center rounded border border-muted px-2 text-xs sm:text-sm">
                {downVotes}
            ...
            {user?._id === authorId && (
                <div className="flex items-center gap-2 justify-center rounded border border-muted px-2 text-xs sm:text-sm">
                    <div
                        className="p-1 sm:p-2 rounded hover:bg-muted cursor-pointer"
                        onClick={() =>
                            dispatch(
                                showConfirmDialog({
                    ...
                    >
                        <Trash2 className="w-4 h-4 sm:w-[17px] sm:h-[17px]" strokeWidth={1} />
                    </div>
                    <div className="h-[20px] sm:h-[25px] bg-muted-foreground/30 w-[1.5px]" />
                    <div
                        onClick={handleEditNavigator}
                        className="flex items-center justify-center gap-1 p-1 sm:p-2 rounded hover:bg-muted cursor-pointer"
                    >
                        <Pencil className="w-4 h-4 sm:w-[17px] sm:h-[17px]" strokeWidth={1} />
                    </div>
                </div>
            )}
        </div>
