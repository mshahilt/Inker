...
import { FaRegComment, FaRegBookmark, FaChevronRight, FaChevronLeft, FaEdit } from 'react-icons/fa';
        ...
        <>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {dummyPosts.map((post, index) => (
              <article 
                key={index}
                className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col h-full"
              >
               <div className="flex items-center justify-between p-4 border-gray-100 dark:border-gray-700">
                ...
                {/* Blog icon and label (right side) */}
                <div className="flex items-center text-black dark:text-blue-400">
                ...
                <div className="flex justify-end items-center px-4 py-3 border-gray-100 dark:border-gray-700">
